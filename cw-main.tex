...
}
{
   ...
   \begin{flalign}
       & AB^2 + BD^2 + CD^2 + AC^2 = \left\lvert \overrightarrow{AB}\right\rvert^2 + \left\lvert \overrightarrow{BD}\right\rvert^2 + \left\lvert \overrightarrow{CD}\right\rvert^2 + \left\lvert \overrightarrow{AC}\right\rvert^2 = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 +                                                & \\ \nonumber
       & + {\overrightarrow {CD}}^2 + {\overrightarrow{AC}}^2 = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + (-\overrightarrow{AC} + \overrightarrow{AB} + \overrightarrow{BD})^2 + {\overrightarrow{AC}}^2 = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 +                                                                & \\ \nonumber
       & + ({\overrightarrow{AC}}^2 - \overrightarrow{AB}\overrightarrow{AC} - \overrightarrow{BD}\overrightarrow{AC} - \overrightarrow{AB}\overrightarrow{AC} + {\overrightarrow{AB}}^2 + \overrightarrow{AB}\overrightarrow{BD} - \overrightarrow{BD}\overrightarrow{AC} + \overrightarrow{AB}\overrightarrow{BD} +                   & \\ \nonumber
       & + {\overrightarrow{BD}}^2) + {\overrightarrow{AC}}^2 = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + {\overrightarrow{AC}}^2 +({\overrightarrow{AC}}^2 - \overrightarrow{AB}\overrightarrow{AC} + {\overrightarrow{AB}}^2 - \overrightarrow{BD}\overrightarrow{AC} + \overrightarrow{AB}\overrightarrow{BD}) = \nonumber
   \end{flalign}
   \begin{flalign*}
       & = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + {\overrightarrow{AC}}^2 + (-\overrightarrow{AB}\overrightarrow{AC} + \overrightarrow{AB}\overrightarrow{BD}) & \\
       & = 2{\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + {\overrightarrow{AC}}^2
   \end{flalign*}

   \begin{flalign}
       & AD^2 + BC^2 = \left\lvert \overrightarrow{AD}\right\rvert^2 + \left\lvert \overrightarrow{BC}\right\rvert^2 = {\overrightarrow{AD}}^2 + {\overrightarrow{BC}}^2 = \left( \overrightarrow{AB} + \overrightarrow{BD}\right)^2 + & \\ \nonumber
       & \left( -\overrightarrow{AB} + \overrightarrow{AC}\right)^2 = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + {\overrightarrow{AC}}^2 + ({\overrightarrow{AB}}^2 + 2AB \cdot BD - 2AC \cdot AB) =                          & \\ \nonumber
       & = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + {\overrightarrow{AC}}^2 + (\overrightarrow{AB} \cdot (AB + 2BD - 2AC))                                                                                                  & \\ \nonumber
       & = 2{\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + {\overrightarrow{AC}}^2
   \end{flalign}
...
}
{
   ...
   соответственно, то середины отрезков \(AA_1\) , \(BB_1\) , \(CC_1\) коллинеарны.
   \begin{figure}[h]
      \centering
   ...
   \lstinputlisting[frame=none,caption={Функция task5::solve},label=task1-code,captionpos=b,firstline=5]{\taskFileName{5}}
   \paragraph{Демонстрация работы:}
