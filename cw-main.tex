...
}
{
   ...
   \begin{flalign}
      \label{t3:s1}
       ...
       & + {\overrightarrow{BD}}^2) + {\overrightarrow{AC}}^2 = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + {\overrightarrow{AC}}^2 +({\overrightarrow{AC}}^2 - \overrightarrow{AB}\overrightarrow{AC} + {\overrightarrow{AB}}^2 - \overrightarrow{BD}\overrightarrow{AC} +
   \end{flalign}
   \begin{flalign*}
       & + \overrightarrow{AB}\overrightarrow{BD}) = {\overrightarrow{AB}}^2 + {\overrightarrow{BD}}^2 + {\overrightarrow{AC}}^2 + (-\overrightarrow{AB}\overrightarrow{AC} + \overrightarrow{AB}\overrightarrow{BD}) & \\
